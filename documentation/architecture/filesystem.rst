...
.. code-block::
    ...
    sources/
    ├── lmscribbles/          # Main Python package
    │   ├── __/                      # Centralized import hub
    │   │   ├── __init__.py          # Re-exports core utilities
    │   │   ├── imports.py           # External library imports
    │   │   └── nomina.py            # lm-scribbles-specific naming constants
    │   ├── __init__.py              # Package entry point
    │   ├── py.typed                 # Type checking marker
    │   ├── __main__.py              # CLI entry point for `python -m lmscribbles`
...
.. code-block::
    ...
    lmscribbles/
    ├── __main__.py      # Entry point: `python -m lmscribbles`
...
Package-wide exceptions are centralized in ``sources/lmscribbles/exceptions.py``
